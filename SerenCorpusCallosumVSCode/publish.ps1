...
.DESCRIPTION
    Runs in SerenCorpusCallosumVSCode/ (where package.json lives).
    ...
    Steps:
      ...
      4. vsce package     - produces seren-corpuscallosum-<version>.vsix
...
# -- guard: must run from SerenCorpusCallosumVSCode/ -----------------------------------

if (-not (Test-Path "package.json")) {
    Die "Run this script from the SerenCorpusCallosumVSCode/ directory (package.json not found here)."
}
